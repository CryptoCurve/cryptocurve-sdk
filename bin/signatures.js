 ...
 * @return {Buffer}
 */
Signatures.prototype.hash = function (t) {
 ...
 * @return {Signature}
 */
Signatures.prototype.sign = function (t, privateKey) {
 ...
 * @return {string}
 */
Signatures.prototype.signMessageWithPrivateKey = function (msg, privateKey) {
 ...
 * @return {Buffer}
 */
Signatures.prototype.signRawTransactionWithPrivateKey = function (tx, privateKey) {
 ...
 * @return {Boolean}
 */
Signatures.prototype.verifySignedMessage = function (msgObject) {
    ...
    const hash = msgObject.version === '2' ?
 ...
 * @return {Buffer}
 */
Signatures.prototype.wanSignRawTransactionWithPrivateKey = function (t, privateKey) {
